...
class EnhancedModerationAPI:
    ...
    def _analyze_pose(self, image_rgb: np.ndarray) -> Dict:
        ...
        try:
            ...
            # Classify pose based on metrics - FIXED: store result in variable first
            pose_result = self._classify_pose(
            ...
            # FIXED: Access the dictionary keys properly
            return {
                'pose_detected': True,
    ...
    def _classify_pose(self, torso_angle: float, hip_bend_angle: float, 
        ...
        # FIXED: Return the dictionary with proper key names
        return {
