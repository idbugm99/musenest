-- Recreate the content_moderation trigger with proper pose analysis support
DELIMITER //
...
BEGIN
    ...
    INSERT INTO media_review_queue (
        ...
        final_risk_score, risk_level, combined_assessment, pose_category
    ) VALUES (
        NEW.id, NEW.model_id, 
        ...
        NEW.final_risk_score, NEW.risk_level, NEW.combined_assessment, NEW.pose_category
    );
END//
